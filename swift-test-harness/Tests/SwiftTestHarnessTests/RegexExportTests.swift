...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Regex.swiftmodule/`
...
//      `import Regex` above would fail at compile time.
//
//   2. The static archive `libRegex.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Regex" }` and
//      `flattenPackage = "io.github.kotlinmania.regex"` configuration in
...
final class RegexExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Regex swift module imported cleanly")
    }
}
