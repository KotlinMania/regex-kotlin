...
This file is the quick-reference operating contract for regex-kotlin. The longer
...
regex-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`regex`](https://crates.io/crates/regex). Upstream Rust is the behavioral oracle while the
