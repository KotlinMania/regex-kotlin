...
kotlin {
    ...
    val xcf = XCFramework("Regex")

    macosArm64 {
        binaries.framework { baseName = "Regex"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Regex"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Regex"
        flattenPackage = "io.github.kotlinmania.regex"
    }

    android {
        namespace = "io.github.kotlinmania.regex"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "regex-kotlin", version.toString())

    pom {
        name.set("regex-kotlin")
        description.set("Kotlin Multiplatform port of rust-lang/regex - An implementation of regular expressions for Rust. This implementation uses finite automata and guarantees linear time matching on all inputs")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/regex-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/regex-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/regex-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/regex-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.regex.codeql
